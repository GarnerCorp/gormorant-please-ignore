...
trait base {
      ...
      if (csv.x == "") Right(())
        ...
        Left(
          Error.DecodeFailure.single(
            "Failed to decode Unit: Received Field $field"
          )
        )
  }
  ...
  implicit val javaBoolGet: Get[lang.Boolean] =
    boolGet.map(java.lang.Boolean.valueOf)
  implicit val javaBoolPut: Put[java.lang.Boolean] =
    boolPut.contramap(_.booleanValue())
  ...
  implicit val charGet: Get[Char] = new Get[Char] {
    def get(csv: CSV.Field): Either[Error.DecodeFailure, Char] =
      if (csv.x.size == 1) Right(csv.x.charAt(0))
        ...
        Left(
          Error.DecodeFailure.single(
            "Failed to decode Char: Received Field $field"
          )
        )
  }
  implicit val charPut: Put[Char] = stringPut.contramap(_.toString)

  implicit val javaCharGet: Get[java.lang.Character] =
    charGet.map(java.lang.Character.valueOf)
  implicit val javaCharPut: Put[java.lang.Character] =
    charPut.contramap(_.charValue())
  ...
  implicit val javaFloatGet: Get[java.lang.Float] =
    floatGet.map(java.lang.Float.valueOf)
  implicit val javaFolatPut: Put[java.lang.Float] =
    floatPut.contramap(_.floatValue())
  ...
  implicit val javaDoubleGet: Get[java.lang.Double] =
    doubleGet.map(java.lang.Double.valueOf)
  implicit val javaDoublePut: Put[java.lang.Double] =
    doublePut.contramap(_.doubleValue())
  ...
  implicit val javaByteGet: Get[java.lang.Byte] =
    byteGet.map(java.lang.Byte.valueOf)
  implicit val javaBytePut: Put[java.lang.Byte] =
    bytePut.contramap(_.byteValue())
  ...
  implicit val javaShortGet: Get[java.lang.Short] =
    shortGet.map(java.lang.Short.valueOf)
  implicit val javaShortPut: Put[java.lang.Short] =
    shortPut.contramap(_.shortValue())

  implicit val javaIntegerGet: Get[java.lang.Integer] =
    intGet.map(java.lang.Integer.valueOf)
  implicit val javaIntegerPut: Put[java.lang.Integer] =
    intPut.contramap(_.intValue())
  ...
  implicit val javaLongGet: Get[java.lang.Long] =
    longGet.map(java.lang.Long.valueOf)
  implicit val javaLongPut: Put[java.lang.Long] =
    longPut.contramap(_.longValue())
  ...
  implicit val javaBigIntegerPut: Put[java.math.BigInteger] =
    bigIntPut.contramap(BigInt.apply)
  ...
  implicit val javaBigDecimalGet: Get[java.math.BigDecimal] =
    bigDecimalGet.map(_.bigDecimal)
  ...
  final def enumerationPut[E <: Enumeration]: Put[E#Value] =
    stringPut.contramap(_.toString)
